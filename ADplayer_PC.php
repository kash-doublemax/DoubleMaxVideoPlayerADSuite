	...
	<?php
		...
		switch($wid){
			case("420"):
				...
				echo '<iframe id="ad1" src="http://ads.doublemax.net/delivery/?iframe&amp;z='.$zid.'"'.'allowtransparency="true" width="190" height="21"
				framespacing="0" frameborder="no" scrolling="no">'."\n".'</iframe>'."\n";
				echo ' </div>'."\n";
				echo '<div style="position:absolute; left:230px; width:21px;">'."\n";
				echo '<iframe id="ad2" src="http://ads.doublemax.net/delivery/?iframe&amp;z='.$zid.'"'.'allowtransparency="true" width="190" height="21"
				framespacing="0" frameborder="no" scrolling="no">'."\n".'</iframe>'."\n";
				echo ' </div>'."\n";
				switch($mode){
					case("yt"):
		...
		echo '<iframe id="ad3" src="http://ads.doublemax.net/delivery/?iframe&amp;z='.$zid2.'"'.'allowtransparency="true"  top="50" width="300" height="250"
		framespacing="0" frameborder="no" scrolling="no">'."\n".'</iframe>'."\n";
		echo ' </div>'."\n";
	?>	
  </body>
